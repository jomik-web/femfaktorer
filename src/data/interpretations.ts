...
export const INTERPRETATIONS: Copy = {
  openness: {
    low: {
      ...
      careerNote:
        "Definerte oppgaver og velprøvde metoder passer godt for deg -- enten det er et studieløp med et tydelig pensum eller en jobb med klare rammer, som drift, forvaltning eller fagområder med etablert praksis, kan det kjennes trygt og oversiktlig. Skal du inn i et mer nyskapende fag eller en mer utforskende rolle, kan det hjelpe å bevisst trene på å tåle usikkerhet i en periode.",
      relationshipNote:
    ...
    mid: {
      ...
      careerNote:
        "Du takler både strukturerte og mer utforskende arbeidsformer rimelig greit, enten det er på skolen eller i en jobb -- det gjør at du passer inn i mange typer fag og roller, fra studier og stillinger med faste rammer til oppgaver som krever litt nytenkning underveis.",
      relationshipNote:
      ...
      synthesis:
        "Du beveger deg naturlig mellom det kjente og det nye. Byr en anledning seg, blir du gjerne med på noe nytt -- uten at du aktivt søker det uprøvde hele tiden. Denne fleksibiliteten gjør deg tilpasningsdyktig i de fleste sammenhenger. Det kan likevel være vanskelig å vite i farten om du egentlig lengter etter noe nytt, eller bare er vant til å tenke at du burde. Privat varierer interessene dine gjerne med hvem du er sammen med. På skolen og jobben takler du rutinepregede og kreative oppgaver omtrent like godt -- en allsidighet som passer inn i mange typer fag og roller. Sammen med en partner tilpasser du deg gjerne den andres behov for stabilitet eller variasjon.",
      closingHook:
    ...
    high: {
      ...
      careerNote:
        "Fag eller roller som gir rom for nytenkning, utforsking eller kreativt arbeid passer godt for deg -- enten det er et studium med åpne oppgaver eller en jobb med frihet til å prøve nye løsninger. Sterkt rutinepregede fag eller stillinger kan over tid oppleves lite stimulerende, siden trangen til å utforske noe nytt melder seg uansett hvor du er.",
      relationshipNote:
      ...
      synthesis:
        "Nye ideer, inntrykk og perspektiver tiltrekker deg tydelig. Det viser seg gjerne som interesse for kunst, en uvant idé, eller et sted du ikke kjenner fra før -- og som en vane med å stille spørsmål ved det andre tar for gitt. Nysgjerrigheten din gjør deg kreativ, og en pådriver når noe faktisk trenger å tenkes nytt. Ren gjentakelse og stor forutsigbarhet kan derimot fort oppleves som utålmodighet, både for deg selv og andre. På skolen og jobben er det ofte du som foreslår en annen løsning enn den vante -- fag eller roller med rom for nytenkning eller kreativt arbeid passer deg godt, mens sterkt rutinepregede fag eller stillinger kan kjennes lite stimulerende over tid. I en kjæreste- eller samboerrelasjon fungerer det som regel best med en partner som tåler, eller helst deler, interessen din for det nye. Blant venner trekkes du gjerne mot dem som byr på nye perspektiver.",
      closingHook:
  ...
  conscientiousness: {
    low: {
      ...
      careerNote:
        "Fag eller roller med stor grad av frihet og variasjon passer ofte bedre for deg enn studier eller stillinger som krever tett, langsiktig oppfølging av detaljer. Ekstern struktur -- faste innleveringsfrister, sjekklister, eller rutiner satt av andre -- kan være god støtte i oppgaver der presisjon er avgjørende, enten det er på skolen eller i en jobb.",
      relationshipNote:
    ...
    mid: {
      ...
      careerNote:
        "Du takler både strukturerte og mer frie arbeidsformer, uansett om det er i studier eller en jobb -- evnen til å justere hvor mye system du legger på en oppgave er en styrke i fag og roller som varierer mye fra dag til dag.",
      relationshipNote:
    ...
    high: {
      ...
      careerNote:
        "Studier eller roller som krever nøyaktighet, pålitelighet og evne til å fullføre over tid passer godt for deg -- lange innleveringer, prosjekter eller fag med mye selvstendig fremdrift kjennes gjerne overkommelige. Vær samtidig oppmerksom på at høye krav til deg selv kan gjøre det vanskeligere å delegere, eller akseptere at noe er «godt nok», enten det gjelder en innlevering eller en arbeidsoppgave.",
      relationshipNote:
  ...
  extraversion: {
    low: {
      ...
      careerNote:
        "Fag eller roller med mer selvstendig arbeid, dybdefokus og færre avbrytelser passer godt for deg -- en lesesal for deg selv eller stille kontortid gir deg ofte mer enn gruppearbeid eller åpne kontorlandskap. Studier eller jobber med mye uforutsigbar sosial kontakt kan tappe mer energi enn de gir tilbake.",
      relationshipNote:
      ...
      synthesis:
        "Ro og egen tid gir deg mer energi enn store forsamlinger av mennesker. Du foretrekker én-til-én-samtaler fremfor store selskaper, og trenger tid alene for å lade opp etter en sosial dag. Denne preferansen gir deg godt fokus og evne til dypere konsentrasjon, uten å bli avledet av det som skjer rundt deg. Mye sosial energi over tid -- nettverksbygging, store arrangementer -- kan derimot kjennes tyngre å holde ut i enn for andre. På skolen og jobben presterer du gjerne best med færre avbrytelser og mer skjermet tid. Fag eller roller med selvstendig arbeid og dybdefokus passer deg bedre enn gruppearbeid eller åpne kontorlandskap. Du trives best med noen få nære relasjoner fremfor et stort nettverk -- en partner som respekterer behovet ditt for egen tid, og venner som forstår at du trenger ro innimellom, passer deg som regel godt.",
      closingHook:
    ...
    mid: {
      ...
      careerNote:
        "Du fungerer godt både i gruppe og med selvstendig arbeid, enten det er på skolen eller i en jobb, og tilpasser deg derfor ulike studie- og arbeidsmiljøer uten at det ene tapper deg mer enn det andre.",
      relationshipNote:
      ...
      synthesis:
        "Sosialt selskap og egen tid deler plassen ganske jevnt i livet ditt, uten at det ene klart dominerer. Du blir gjerne med på sosiale ting, men setter også pris på en kveld helt alene uten at det føles som noe savn. Denne vekslingen gjør deg fleksibel i de fleste sosiale situasjoner. Det kan likevel være vanskelig å kjenne etter i farten om det egentlig er ro eller selskap du trenger mest. Energien din varierer en del fra dag til dag. På skolen og jobben fungerer du godt både i gruppe og med selvstendig arbeid, og tilpasser deg dermed ulike studie- og arbeidsmiljøer. I relasjonene dine finner du som regel selv en rimelig balanse mellom samvær med partner og venner, og egen tid.",
      closingHook:
    ...
    high: {
      ...
      careerNote:
        "Studier eller jobber der du får møte mennesker, samarbeide, påvirke eller formidle -- som gruppeprosjekter, verv, salg eller kundekontakt -- gir deg ofte energi i stedet for å tappe deg. Dager med variasjon og jevnlig kontakt med andre passer deg bedre enn lange strekk med stillesittende arbeid alene, enten det er på lesesalen eller på jobb.",
      relationshipNote:
  ...
  agreeableness: {
    low: {
      ...
      careerNote:
        "Fag eller roller som krever tøffe forhandlinger, tydelige beslutninger, eller å stå alene i uenighet, passer ofte godt for deg -- for eksempel debatt, forhandling eller prosjekter der noen må ta et tydelig standpunkt. I gruppearbeid på skolen eller team på jobb kan det være nyttig å bevisst løfte frem andres perspektiv, selv når du er trygg på ditt eget.",
      relationshipNote:
      ...
      synthesis:
        "Egne vurderinger veier tungt hos deg, også når de støter mot det andre mener. Du sier tydelig fra når du er uenig, og forhandler hardt når det trengs. Denne tydeligheten gjør deg god til å sette grenser og stå støtt i konflikt når det faktisk er nødvendig. Tett samarbeid kan derimot dra nytte av at du bevisst løfter frem den andre partens perspektiv, selv når du er trygg på ditt eget. På skolen og jobben er det ofte du som utfordrer beslutninger andre ikke våger å stille spørsmål ved -- fag eller roller som krever tøffe forhandlinger eller tydelige beslutninger passer deg derfor godt. Du setter grenser tydelig overfor en partner eller venner, noe som kan være en styrke i seg selv. Nære relasjoner trenger likevel av og til at du bevisst viser at du bryr deg, ikke bare at du har rett.",
      closingHook:
    ...
    mid: {
      ...
      careerNote:
        "Du tilpasser samarbeidsstilen din etter hvem du jobber eller studerer sammen med, og fungerer derfor rimelig godt i de fleste grupper -- enten det er en studiegruppe eller et team på jobb -- verken for ettergivende eller for konfronterende.",
      relationshipNote:
      ...
      synthesis:
        "Egne og andres behov teller omtrent likt for deg, avhengig av situasjonen du står i. Du gir deg gjerne i en diskusjon den ene dagen, og holder på ditt den neste, uten noe fast mønster. Denne jevne vektingen gjør deg til en forutsigbar og rettferdig samarbeidspartner. Utfordringen kan være å skjønne i farten når du egentlig burde sette deg selv først -- eller omvendt. På skolen og jobben tilpasser du samarbeidsstilen din etter hvem du jobber eller studerer med, og fungerer derfor rimelig godt i de fleste grupper og team. Du gir og tar omtrent i lik grad i relasjoner også -- en balansert stil som en partner eller venner som regel opplever som rimelig.",
      closingHook:
    ...
    high: {
      ...
      careerNote:
        "Du er en verdsatt samarbeidspartner i gruppearbeid og team, men risikerer å ta på deg mer enn du burde for å hjelpe andre -- både i en studiegruppe og på jobb. Bevisst grensesetting kan derfor være ekstra viktig for deg.",
      relationshipNote:
      ...
      synthesis:
        "Andres behov opptar en stor plass hos deg, og du finner ofte glede i å hjelpe. Du sier gjerne ja når noen ber om hjelp, selv når det koster deg noe, og velger heller å unngå konflikt enn å skape uenighet. Andre lener seg gjerne på deg som en varm, tillitsvekkende samarbeidspartner nettopp derfor. Å sette grenser kan derimot bli vanskeligere med det samme trekket, selv når det går ut over deg selv. På skolen og jobben tar du ofte på deg mer enn du burde for å hjelpe andre -- bevisst grensesetting kan derfor være ekstra viktig for deg, selv som en verdsatt samarbeidspartner i gruppearbeid og team. Privat bruker du mye energi på å unngå at noen blir skuffet. En partner eller venner lener seg gjerne på deg som en varm og støttende person å ha rundt seg -- pass på at det ikke går på bekostning av dine egne behov i det lange løp.",
      closingHook:
  ...
  stability: {
    low: {
      ...
      careerNote:
        "Høyt tempo, stramme frister og mye uforutsigbarhet -- enten det er eksamensperioder, innleveringer eller en travel jobb -- kan kjennes tyngre for deg enn for mange andre. Studier eller roller med noe mer forutsigbarhet, og støtte fra medstudenter, kolleger eller leder, kan gjøre stor forskjell.",
      relationshipNote:
      ...
      synthesis:
        "Bekymring, uro og humørsvingninger rammer deg noe hardere enn mange andre i perioder. Smått kan vokse seg stort i tankene dine, og humøret ditt kan svinge en del i løpet av én og samme dag. Denne følsomheten betyr også at du er følelsesmessig oppmerksom, og legger merke til nyanser i stemninger som andre overser. I stressende perioder er det ekstra viktig for deg å ha noen faste holdepunkter -- rutiner, mennesker eller steder -- som hjelper deg å roe deg selv ned. På skolen og jobben kjennes press, eksamener og tidsfrister ofte tyngre enn de ser ut til for andre. Studier eller roller med noe mer forutsigbarhet, sammen med støtte fra medstudenter, kolleger eller leder, kan gjøre stor forskjell. Forutsigbarhet og tydelig kommunikasjon fra en partner og nære venner hjelper deg å kjenne deg trygg. Det kan være verdt å være åpen om hva som skaper uro for deg, slik at de rundt deg kan møte det.",
      closingHook:
    ...
    mid: {
      ...
      careerNote:
        "Du tåler et visst press fra studier eller jobb uten at det går nevneverdig utover deg, men flere krevende ting samtidig -- som eksamen og innleveringer på én gang, eller flere prosjekter parallelt -- kan likevel kjennes tyngre. Faste rutiner kan være en nyttig støtte i travle perioder, enten det er på skolen eller jobben.",
      relationshipNote:
      ...
      synthesis:
        "Livets opp- og nedturer håndteres med en ganske jevn linje hos deg. Du blir litt stresset eller nedfor når noe faktisk er krevende, men det tar sjelden overhånd eller varer unødvendig lenge. Denne jevne linjen gir deg en solid, stabil grunnmur å møte hverdagen fra. Er flere ting krevende samtidig, eller varer presset lenge, kan det likevel være nyttig å ha noen faste rutiner å støtte deg på. På skolen og jobben tåler du et visst press uten at det går nevneverdig utover deg -- faste rutiner kan være en nyttig støtte i travle perioder, som eksamenstid eller innleveringsfrister. Du er som regel den nokså rolige i opp- og nedturer sammen med en partner eller venner også, uten at det betyr at ingenting berører deg.",
      closingHook:
    ...
    high: {
      ...
      careerNote:
        "Du takler press og uforutsigbarhet bedre enn mange andre, noe som kan gjøre deg til en verdifull ressurs i krevende perioder -- enten det er en tøff eksamensperiode eller en krisepreget jobb. Vær samtidig oppmerksom på at det samme trekket kan gjøre deg mindre lydhør for tidlige varselsignaler, både på skolen og jobben.",
      relationshipNote:
      ...
      synthesis:
        "Stress og motgang preller lettere av deg enn hos mange andre, selv når mye skjer samtidig. Andre kommer gjerne til deg når noe er vanskelig, fordi du sjelden virker overveldet. Kritikk tar sjelden tak i deg over lang tid. Roen din gjør deg til en stødig støtte for andre i krevende situasjoner, og gir deg selv ro til å tenke klart under press. Baksiden er at du lettere overser reell risiko og tidlige varselsignaler. På skolen og jobben er du gjerne den som holder hodet kaldt når andre stresser -- en egenskap som kan gjøre deg til en verdifull ressurs i krevende perioder, eksamener eller krisepregede roller. Vær bevisst på at folk rundt deg noen ganger må si tydelig ifra før du fanger opp at noe er galt. Du er gjerne den stødige når en partner eller venner går gjennom noe vanskelig -- pass på at de som reagerer sterkere enn deg ikke opplever at bekymringene deres blir avfeid.",
      closingHook:
 ...
 *
 * v2.34 (produkteiers ønske 23.07.2026): ny valgfri `richCombos`-modus for
 * oppsummeringen på Utvidet-tieren (290 spm). Den har både høyest presisjon
 * på fasettnivå (10 spm/fasett) og det største fasettbiblioteket å hente
 * kombinasjonsfunn fra, så oppsummeringen der skal dekke FLERE
 * personlighetstrekk (opptil 5 definerende hovedfaktorer i stedet for 3) og
 * legge tydeligere vekt på SAMSPILLET mellom hoved- og underkategorier
 * (opptil 4 kombinasjonssetninger i stedet for 2, og opptil 2 av dem hentet
 * fra det mer presise fasettnivået i stedet for bare 1). Full-tieren (120
...
export function buildClosingSynthesis(
  ...
  facets: FacetResult[],
  options: { skipCombos?: boolean; richCombos?: boolean } = {}
): ClosingSynthesis {
  const sorted = [...factors].sort((a, b) => Math.abs(b.score - 50) - Math.abs(a.score - 50));
  const maxDefining = options.richCombos ? 5 : 3;
  const defining = sorted.filter((f) => bandFor(f.score) !== "mid").slice(0, maxDefining);
  ...
  for (const c of matchedDomainCombos.slice(0, Math.max(0, maxTotalCombos - comboSentences.length))) {
    comboSentences.push(
