  ...
  return (
    <main className="mx-auto flex max-w-2xl flex-col gap-10 px-6 py-16">
      ...
      <section id="kort-oppsummert" className="flex flex-col gap-3">
        <h2 className="text-lg font-semibold text-indigo dark:text-white">Kort oppsummert</h2>
      ...
      <section id="testsvar" className="flex flex-col gap-4">
        <h2 className="text-lg font-semibold text-indigo dark:text-white">Testsvarene dine</h2>
        <p className="text-indigo/80 dark:text-lavender-400/80">
      ...
      <section id="tredjeparter" className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-3">
          <article className="rounded-lg bg-lavender-100/50 p-4 dark:bg-white/5">
            <h3 className="font-semibold text-indigo dark:text-white">Netlify -- hosting og drift</h3>
            ...
            <p className="mt-2 text-sm text-indigo/60 dark:text-lavender-400/60">
          ...
          <article className="rounded-lg bg-lavender-100/50 p-4 dark:bg-white/5">
            <h3 className="font-semibold text-indigo dark:text-white">Resend -- e-postutsending</h3>
            <p className="text-sm text-indigo/80 dark:text-lavender-400/80">
          ...
          <article className="rounded-lg bg-lavender-100/50 p-4 dark:bg-white/5">
            <h3 className="font-semibold text-indigo dark:text-white">
      ...
      <section id="rettigheter" className="flex flex-col gap-4">
        <h2 className="text-lg font-semibold text-indigo dark:text-white">Dine rettigheter</h2>
        <p className="text-indigo/80 dark:text-lavender-400/80">
      ...
      <section id="status" className="flex flex-col gap-3 rounded-lg bg-lavender-100/50 p-5 dark:bg-white/5">
        <h2 className="text-lg font-semibold text-indigo dark:text-white">Status på denne siden</h2>
        <p className="text-indigo/80 dark:text-lavender-400/80">
        ...
        <p className="text-sm text-indigo/60 dark:text-lavender-400/60">Sist oppdatert: 14.07.2026.</p>
      </section>

      <section id="kontakt" className="flex flex-col gap-3">
        <h2 className="text-lg font-semibold text-indigo dark:text-white">Kontakt</h2>
        <p className="text-indigo/80 dark:text-lavender-400/80">
