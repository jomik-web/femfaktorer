  ...
  return (
    <main className="mx-auto flex max-w-2xl flex-col gap-10 px-6 py-16">
      ...
      <section id="slik-fungerer" className="flex flex-col gap-4">
        <h2 className="text-xl font-semibold text-ink dark:text-white">Slik fungerer testen</h2>
        <p className="text-ink/80 dark:text-warmgray/80">
        ...
        <div className="flex flex-col gap-3 rounded-lg bg-mint/50 p-5 dark:bg-white/5">
          <h3 className="font-semibold text-ink dark:text-white">Hva resultatet bygger på</h3>
          <p className="text-ink/80 dark:text-warmgray/80">
        ...
        <div className="flex flex-col gap-3">
          <h3 className="font-semibold text-ink dark:text-white">Hva testen kan brukes til</h3>
          <p className="text-ink/80 dark:text-warmgray/80">
      ...
      <section id="femfaktormodellen" className="flex flex-col gap-4">
        <h2 className="text-xl font-semibold text-ink dark:text-white">Om femfaktormodellen</h2>
        <p className="text-ink/80 dark:text-warmgray/80">
        ...
        <div className="flex flex-col gap-4">
          {FACTORS.map((f) => (
            <article key={f.name} className="rounded-lg bg-mint/50 p-5 dark:bg-white/5">
              <h3 className="font-semibold text-ink dark:text-white">{f.name}</h3>
              <p className="text-ink/80 dark:text-warmgray/80">{f.text}</p>
            </article>
          ))}
        </div>
        <div className="flex flex-col gap-3">
          <h3 className="font-semibold text-ink dark:text-white">Ikke en type</h3>
          <p className="text-ink/80 dark:text-warmgray/80">
      ...
      <section id="metode-og-kilder" className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-3">
          <h3 className="font-semibold text-ink dark:text-white">Kilder og referanser</h3>
          <p className="text-ink/80 dark:text-warmgray/80">
