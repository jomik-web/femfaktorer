  ...
  return (
    <main className="mx-auto flex max-w-2xl flex-col gap-8 px-6 py-16">
      <header className="flex flex-col gap-3">
        <h1 className="text-2xl font-semibold text-indigo dark:text-white sm:text-3xl">Hjelp</h1>
      ...
      <section className="flex flex-col gap-3">
        <h2 className="font-semibold text-indigo dark:text-white">Hvor lagres svarene mine?</h2>
        <p className="text-indigo/80 dark:text-lavender-400/80">
      ...
      <section className="flex flex-col gap-3">
        <h2 className="font-semibold text-indigo dark:text-white">Hva skjer når jeg snakker med Spir?</h2>
        <p className="text-indigo/80 dark:text-lavender-400/80">
      ...
      <section className="flex flex-col gap-3 rounded-lg bg-lavender-100/50 p-5 dark:bg-white/5">
        <h2 className="font-semibold text-indigo dark:text-white">Trenger du å snakke med noen?</h2>
        <p className="text-indigo/80 dark:text-lavender-400/80">
        ...
        <ul className="flex flex-col gap-1.5 text-indigo/80 dark:text-lavender-400/80">
          <li>
