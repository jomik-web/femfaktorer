...
- **CSP er VERIFISERT OG SKRUDD PÅ** (01.08.2026). Du gikk gjennom hele flyten i Chrome -- forsiden, testen, resultatet, PDF, delekort, Spir, innlogging, passkey og adminpanelet -- uten ett eneste brudd i konsollen. Headeren blokkerer nå faktisk. Skal noe endres i den senere, står oppskriften for hvordan du verifiserer på nytt i `netlify.toml`.
